...
}, 'maker.auto_command.make_sonata_admin' => function (): \Symfony\Bundle\MakerBundle\Command\MakerCommand {
    return ($this->privates['maker.auto_command.make_sonata_admin'] ?? $this->load('getMaker_AutoCommand_MakeSonataAdminService.php'));
