...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ArticlesRepository' => function () {
    return ($this->privates['App\Repository\ArticlesRepository'] ?? $this->load('getArticlesRepositoryService.php'));
}, 'App\\Repository\\BlogPostRepository' => function () {
    return ($this->privates['App\Repository\BlogPostRepository'] ?? $this->load('getBlogPostRepositoryService.php'));
