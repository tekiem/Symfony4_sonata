...
// Returns the public 'admin.blog_post' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\BlogPostAdmin.php';
...
$this->factories['admin.blog_post'] = function () {
    $instance = new \App\Admin\BlogPostAdmin('admin.blog_post', 'App\\Entity\\BlogPost', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setTemplateRegistry(($this->services['admin.blog_post.template_registry'] ?? $this->load('getAdmin_BlogPost_TemplateRegistryService.php')));
...
return $this->factories['admin.blog_post']();
