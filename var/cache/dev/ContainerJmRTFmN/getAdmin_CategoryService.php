...
include_once $this->targetDirs[3].'\\src\\Admin\\CategoryAdmin.php';
...
$this->factories['admin.category'] = function () {
    $instance = new \App\Admin\CategoryAdmin('admin.category', 'App\\Entity\\Category', 'Sonata\\AdminBundle\\Controller\\CRUDController');
